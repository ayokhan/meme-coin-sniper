# NovaStaris — Architecture (Patent Attachment)

**Standalone technical summary for patent application.**  
Use this document separately from the main patent support document when attaching drawings or technical summary.
...
*Patent attachment — architecture and technical summary.*
