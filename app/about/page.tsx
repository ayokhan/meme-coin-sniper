        ...
        <Card className="rounded-2xl border-zinc-200/90 dark:border-zinc-800/90 bg-white/80 dark:bg-zinc-900/80 backdrop-blur-sm shadow-lg overflow-hidden mb-8">
          <CardContent className="p-6 space-y-6 text-zinc-700 dark:text-zinc-300">
              <p className="text-base leading-relaxed">
                <strong className="text-zinc-900 dark:text-zinc-100">NovaStaris</strong> brings AI-powered discovery and analysis to <strong className="text-zinc-900 dark:text-zinc-100">Solana</strong> and <strong className="text-zinc-900 dark:text-zinc-100">BSC</strong> meme coins, plus <strong className="text-zinc-900 dark:text-zinc-100">Crypto Futures</strong>. We combine real-time on-chain data, social signals, and NovaStaris AI Analysis so you can discover and evaluate viral tokens before the crowd—and decide with confidence.
              </p>
              <p className="text-base leading-relaxed">
                Our system surfaces new pairs, trending volume, and surge activity on Solana and BSC (BSC tab includes <strong className="text-zinc-900 dark:text-zinc-100">Go Hunting</strong>: New pairs, Final Stretch, Migrated, and Trending—all users can access the BSC tab). We layer on <strong className="text-zinc-900 dark:text-zinc-100">NovaStaris AI Analysis</strong>: paste any Solana or BSC token contract address and get a 0–100 score, a clear buy/no-buy signal, and a concise explanation (BSC AI Analysis is <strong className="text-zinc-900 dark:text-zinc-100">for Pro and VIP only</strong>). <strong className="text-zinc-900 dark:text-zinc-100">Pro</strong> subscribers get Surge, Transactions, NovaStaris AI Analysis (Solana and BSC), and Crypto Futures. <strong className="text-zinc-900 dark:text-zinc-100">VIP</strong> adds the Twitter tracker (CT Scan), Wallet Tracker (Meme Coins Traders + Top Leverage Traders), and Coach Calls + Telegram Signals. Add your own meme coin wallets (max 5) or leverage wallets (unlimited); alerts for your wallets are in-app. Coach Calls: exclusive CA in-app and via our Telegram Call channel; add your Telegram ID to get signals there.
              </p>
              <p className="text-base leading-relaxed">
              ...
              <div className="grid gap-4 sm:grid-cols-2 pt-4">
                ...
                <div className="flex gap-3 rounded-xl border border-zinc-200/80 dark:border-zinc-700/80 bg-zinc-50/80 dark:bg-zinc-800/50 p-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-zinc-900 dark:text-zinc-100">VIP: CT Scan, Wallet Tracker & Coach Calls + Telegram Signals</h3>
                    <p className="text-sm text-zinc-600 dark:text-zinc-400 mt-1">
                      VIP subscribers get CT Scan (Twitter tracker), Wallet Tracker (Meme Coins Traders + Top Leverage Traders), and Coach Calls + Telegram Signals. Add your own meme coin wallets (max 5) or leverage wallets (unlimited); alerts are in-app. Coach Calls: exclusive CA in-app and via Telegram; add your Telegram ID to get signals there.
                    </p>
                  </div>
                </div>
