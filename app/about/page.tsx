        ...
        <div className="text-center mb-12">
          <h1 className="text-3xl sm:text-4xl font-black tracking-tight bg-gradient-to-r from-cyan-400 via-violet-400 to-blue-500 bg-clip-text text-transparent">
            ...
            <p className="mt-3 text-lg text-zinc-600 dark:text-zinc-400 max-w-2xl mx-auto">
              Spot viral tokens before the crowd. Analyze with NovaStaris AI Agent in seconds. Move with smart money—Solana, BSC, Crypto Futures, <strong className="text-violet-500 dark:text-violet-400">NovaForecast Agent</strong> (where to look for your next short or long futures entry), <strong className="text-violet-500 dark:text-violet-400">NovaQ (NovaIntelligence)</strong>, <strong className="text-cyan-600 dark:text-cyan-400">NovaStaris AI Trading Bot</strong>, and <strong className="text-cyan-600 dark:text-cyan-400">NovaConnect</strong>. All in one platform.
            </p>
        </div>
          ...
          <CardContent className="p-6 space-y-6 text-zinc-700 dark:text-zinc-300">
              ...
              <div className="grid gap-4 sm:grid-cols-2 pt-4">
                ...
                <div className="flex gap-3 rounded-xl border border-zinc-200/80 dark:border-zinc-700/80 bg-zinc-50/80 dark:bg-zinc-800/50 p-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-zinc-900 dark:text-zinc-100">VIP: CT Scan (on-demand), Wallet Tracker, Coach Calls, NovaForecast Agent, NovaQ, Nova Investment Agent + NovaStaris AI Trading Bot</h3>
                    <p className="text-sm text-zinc-600 dark:text-zinc-400 mt-1">
                      VIP subscribers get CT Scan (Twitter tracker) on-demand and Wallet Tracker access: Top Leverage Traders for all VIP users, plus Meme Coins Traders on-demand. Add Coach Calls + Telegram Signals, <strong className="text-zinc-900 dark:text-zinc-100">NovaForecast Agent</strong>, <strong className="text-zinc-900 dark:text-zinc-100">NovaQ</strong> (support/resistance + direction), and <strong className="text-zinc-900 dark:text-zinc-100">Nova Investment Agent</strong> (risk/duration leverage strategy planning), plus the NovaStaris AI Trading Bot (Crypto Futures on Blofin). Add your own meme coin wallets (max 5) or leverage wallets (unlimited). Coach Calls: exclusive CA in-app and via Telegram; add your Telegram ID to get signals there.
                    </p>
                  </div>
                </div>
                <div className="flex gap-3 rounded-xl border border-zinc-200/80 dark:border-zinc-700/80 bg-zinc-50/80 dark:bg-zinc-800/50 p-4">
