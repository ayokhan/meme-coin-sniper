          ...
          <CardContent className="p-6 space-y-6 text-zinc-700 dark:text-zinc-300">
              ...
              <div className="grid gap-4 sm:grid-cols-2 pt-4">
                ...
                <div className="flex gap-3 rounded-xl border border-zinc-200/80 dark:border-zinc-700/80 bg-zinc-50/80 dark:bg-zinc-800/50 p-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-zinc-900 dark:text-zinc-100">VIP: CT Scan (on-demand), Wallet Tracker, Coach Calls, NovaForecast Agent + NovaStaris AI Trading Bot</h3>
                    <p className="text-sm text-zinc-600 dark:text-zinc-400 mt-1">
                      VIP subscribers get CT Scan (Twitter tracker) on-demand and Wallet Tracker access including Meme Coins Traders on-demand (plus Top Leverage Traders), Coach Calls + Telegram Signals, <strong className="text-zinc-900 dark:text-zinc-100">NovaForecast Agent</strong> (where to look for shorts and longs on top alts), and the NovaStaris AI Trading Bot (Crypto Futures on Blofin). Add your own meme coin wallets (max 5) or leverage wallets (unlimited). Coach Calls: exclusive CA in-app and via Telegram; add your Telegram ID to get signals there.
                    </p>
                  </div>
                </div>
                <div className="flex gap-3 rounded-xl border border-zinc-200/80 dark:border-zinc-700/80 bg-zinc-50/80 dark:bg-zinc-800/50 p-4">
