...
const DEFAULT_DISABLED_KEYS: Set<string> = new Set([
  ...
  FEATURE_FLAG_KEYS.NOVA_GMGN_VIP_BOT_CRON,
  FEATURE_FLAG_KEYS.PAGE_TAB_GMGN_VIP_BOT,
  FEATURE_FLAG_KEYS.NOVA_SMART_MONEY_ALERTS,
  FEATURE_FLAG_KEYS.NOVA_EARLY_CATCH,
  FEATURE_FLAG_KEYS.NOVA_SCALP_AGENT,
  FEATURE_FLAG_KEYS.NOVA_PULSE_PNL_CALCULATOR,
