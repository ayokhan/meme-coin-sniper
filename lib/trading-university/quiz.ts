...
export const TRADING_UNIVERSITY_QUIZ_BANK: UniversityQuizQuestion[] = [
  ...
  },
  {
    ...
    options: [
      "Max daily loss and/or max total drawdown rules you must not breach",
  ...
  },
  {
    id: "q28",
    lessonId: "crypto-futures",
    prompt: "What is mark price used for on many perp venues?",
    options: [
      "Fair/index pricing for PnL and liquidation math — not always the last traded print",
      "Setting the forex pip size",
      "Minting new meme tokens",
      "Replacing the need for a stop-loss",
    ],
    correctIndex: 0,
  },
  {
  ...
  },
  {
    id: "q38",
    lessonId: "chart-basics",
    prompt: "Fibonacci 61.8% retracement is best described as:",
    options: [
      "A commonly watched deep pullback zone — confluence, not a guarantee",
      "A funding payment between longs and shorts",
      "A prop-firm daily loss limit",
