...
const SPECS: Record<MarketingPostcardId, Spec> = {
  ...
  "investor-onepager": {
    ...
    caption: [
      "NovaStaris — AI trading platform. Partnership & investment opportunity.",
      "Live product · VIP users · Blofin, Coinbase, TIOmarkets, Vantage.",
      "AI bots on traders’ own exchange/broker accounts (non-custodial).",
      "",
      "Inquiries: novastaris.ai@gmail.com",
      "https://novastaris.ai",
    ].join("\n"),
  },
};
