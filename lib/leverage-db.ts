...
export const leverageDb = prisma as unknown as {
  leverageWallet: {
    findMany: (args?: { where?: { active?: boolean; alertEnabled?: boolean; global?: boolean }; orderBy?: { createdAt: string } }) => Promise<Array<{ id: string; address: string; nickname: string | null; active: boolean; alertEnabled: boolean; global?: boolean; createdAt: Date }>>;
    ...
    updateMany: (args: { where: { address: string }; data: { nickname?: string | null; active?: boolean; alertEnabled?: boolean; global?: boolean } }) => Promise<unknown>;
