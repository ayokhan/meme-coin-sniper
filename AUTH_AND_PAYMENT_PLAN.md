...
- **VIP:** $20/1-day trial (no card fee); $150/month USDC ($158 card); 6 months $750 USDC ($758 card); 12 months $1,500 USDC ($1,508 card)
- **Card fee:** $8 per card checkout except VIP 1-day trial (USDC pays list price only)
